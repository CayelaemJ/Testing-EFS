...
export async function grantUserSection(userId, sectionKey) {
...
export async function revokeUserSection(userId, sectionKey) {
...
export async function sectionsForUser(user) {
