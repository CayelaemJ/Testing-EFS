...
must(server.includes('X-Empower-Portal-Build') && server.includes('no-store, no-cache') && server.includes('version: "0.5.4"'), 'server must expose build identity and disable stale UI caching');
